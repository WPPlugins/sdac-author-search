=== SDAC Author Search ===
Tags: search, custom search, author search, logged in
Contributors: jenz
...
Customized search form that gives logged in authors the ability to search exclusively within their own content.
...
== Screenshots ==
1. Search after user is logged in example
